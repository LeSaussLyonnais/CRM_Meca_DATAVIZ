...
urlpatterns = [
    ...
    path('PDC_Poste_Tache', endpt_pdc_machine_tache, name="page_PDC_Poste_TacheWS"),
    ...
    path('Last10OF_Poste_<str:nom_poste>/', TacheLast10OFView.as_view(), name="blog-tache-Ordo"),
    path('Poste_<str:nom_poste>/Annee_<str:num_annee>/Semaine_<str:num_semaine>/', TachePDCView.as_view(), name="blog-tache"),
